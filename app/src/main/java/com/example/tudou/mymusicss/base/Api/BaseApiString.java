package com.example.tudou.mymusicss.base.Api;
 ...
 */
public abstract class BaseApiString implements Function<String, String> {
    //rx生命周期管理
    ...
    /*基础url*/
    private String baseUrl = "http://47.97.169.140:9335/Index.asmx/";
    ...
    public BaseApiString(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity) {
